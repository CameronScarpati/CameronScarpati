...
An interactive mathematics demo built with React, TypeScript, and HTML5 canvas. It animates the hailstone trajectories of the 3n + 1 problem, grows the reverse Collatz tree into an organic coral rendering, and charts total stopping times with the record setters highlighted, with the mathematics typeset beside each chart. I built it to explore mathematical visualization.
